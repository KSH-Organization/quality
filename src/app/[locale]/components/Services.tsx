...
export default function Services() {
  ...
  return (
    <section id="services" className="bg-gray-50 py-12 md:py-20 px-4 md:px-6">
      <div
        className="max-w-[1500px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8"
        dir="ltr"
      >
